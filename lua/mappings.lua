...
-- lspsaga
u.map('n', '<c-j>', ':Lspsaga diagnostic_jump_next<CR>', {noremap = true, silent = true})
-- u.map('n', 'K', '<cmd>lua require(\'lspsaga.hover\').render_hover_doc()<CR>', {noremap = true, silent = true})
u.map('n', 'K', ':Lspsaga hover_doc<CR>', {noremap = true, silent = true})
u.map('n', 'gh', ':Lspsaga lsp_finder<CR>', {noremap = true, silent = true})
-- u.map('n', '<space>ca', '<cmd>lua require(\'lspsaga.codeaction\').code_action()<CR>', {noremap = true, silent = true})
u.map('n', '<space>ca', ':Lspsaga code_action<CR>', {noremap = true, silent = true})
u.map('v', '<space>ca', ':<C-U>lua require(\'lspsaga.codeaction\').range_code_action()<CR>', {noremap = true, silent = true})
...
u.map('n', 'rn', '<cmd>lua require(\'lspsaga.rename\').rename()<CR> ', {noremap = true, silent = true})
u.map('n', 'gp', ':Lspsaga preview_definition<CR>', {noremap = true, silent = true})
u.map('n', '<space>d', ':Lspsaga show_line_diagnostics<CR>', {noremap = true, silent = true})
u.map('n', '[e', ':Lspsaga diagnostic_jump_prev<CR>', {noremap = true, silent = true})
u.map('n', ']e', ':Lspsaga diagnostic_jump_next<CR>', {noremap = true, silent = true})
u.map('n', '<leader>t', ':Lspsaga open_floaterm<CR>', {noremap = true, silent = true})
u.map('t', '<leader>t', '<C-\\><C-n>:Lspsaga close_floaterm<CR>', {noremap = true, silent = true})
-- }}}
