...
u.map('n', ';cT', 'OTODO: <ESC>:CommentToggle<CR>A', opts)
u.map('n', ';ct', 'ITODO: <ESC>:CommentToggle<CR>^', opts)
u.map('n', ';cN', 'ONOTE: <ESC>:CommentToggle<CR>A', opts)
u.map('n', ';cn', 'INOTE: <ESC>:CommentToggle<CR>^', opts)
u.map('n', ';cF', 'OFIX: <ESC>:CommentToggle<CR>A', opts)
u.map('n', ';cf', 'IFIX: <ESC>:CommentToggle<CR>^', opts)
u.map('n', ';cW', 'OWARNING: <ESC>:CommentToggle<CR>A', opts)
u.map('n', ';cw', 'IWARNING: <ESC>:CommentToggle<CR>^', opts)
u.map('n', ';cH', 'OHACK: <ESC>:CommentToggle<CR>A', opts)
u.map('n', ';ch', 'IHACK: <ESC>:CommentToggle<CR>^', opts)
u.map('n', ';cP', 'OPERF: <ESC>:CommentToggle<CR>A', opts)
